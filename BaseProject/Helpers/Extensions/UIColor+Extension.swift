...
extension UIColor {
	static var Gray0 : UIColor {get{return UIColor(hex: 0x333333)!}}
	static var Gray1 : UIColor {get{return UIColor(hex: 0x666666)!}}
	static var Gray2 : UIColor {get{return UIColor(hex: 0x999999)!}}
	static var Gray3 : UIColor {get{return UIColor(hex: 0xCCCCCC)!}}
	static var Gray4 : UIColor {get{return UIColor(hex: 0xDDDDDD)!}}
	static var Gray5 : UIColor {get{return UIColor(hex: 0xF0F0F0)!}}
	static var Gray6 : UIColor {get{return UIColor(hex: 0xF5F5F5)!}}
	static var Gray7 : UIColor {get{return UIColor(hex: 0xE7E7E7)!}}
	static var Gray8 : UIColor {get{return UIColor(hex: 0xB2B2B2)!}}
}
...
extension UIColor {
	...
	convenience init(grayScale: Int) {
		self.init(red: CGFloat(grayScale) / 255,
				  green: CGFloat(grayScale) / 255,
				  blue: CGFloat(grayScale) / 255,
				  alpha: 1)
	}
